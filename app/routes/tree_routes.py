...
from app.schemas.tree_schemas import NewTreeSchema, PublicTreeSchema
...
@tree_router.get("/trees", response_model=List[PublicTreeSchema], tags=[tree_tag],
                 summary="Показать все деревья текущего пользователя")
